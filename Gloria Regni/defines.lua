...
NMilitary = {
	...
	RETINUE_REINFORCE_RATE = 0.075,
	RETINUE_REINFORCE_COST = 1.5,					-- Retinues cost while reinforcing.
	RETINUE_CONSTANT_COST = 0.25, 					-- Retinues cost at all times.
	MIN_RETINUE = 5,								-- Minimum retinue ( Disabled for now, can be enabled by mods )
